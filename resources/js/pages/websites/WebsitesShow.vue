...
<template>
    <DefaultLayout>
        ...
        <div v-else-if="website" class="py-6">
            <div class="lg:grid lg:grid-cols-12 lg:gap-0">
                <!-- Main Content -->
                <div class="lg:col-span-7">
                    ...
                    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        ...
                        <div class="border-t border-gray-200">
                            ...
                            <div v-else class="text-center py-6 text-gray-500 text-sm">No pages added yet.</div>
                        </div>
                    </div>
                </div>

                <!-- Sidebar: Recent Checks Timeline -->
                <div class="lg:col-span-3 lg:col-start-9 mt-8 lg:mt-0">
                    <div class="bg-whiteoverflow-hidden sticky top-6">
                        <div class="py-3">
                            <h3 class="text-sm font-medium text-gray-900">Recent Checks</h3>
                        </div>
                        <div class="overflow-y-auto max-h-[calc(100vh-180px)]">
                            <div v-if="website.recent_checks && website.recent_checks.length > 0" class="space-y-1">
                                <div v-for="check in website.recent_checks" :key="check.id" class="py-1.5">
                            ...
                            <div v-else class="py-8 text-center">
                                ...
                                <p class="mt-2 text-xs text-gray-500">No checks yet</p>
                            </div>
                        </div>
                    </div>
                </div>
